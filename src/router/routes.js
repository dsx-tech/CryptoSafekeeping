...
const routes = [
  {
    ...
    children: [
      ...
      { path: '/EthereumMultisigAddressPage/:signs?/:holders?/:keylist?/:address?/:name?/:contacts?/:net?', component: () => import('pages/EthereumMultisigAddressPage.vue'), name: 'EthereumMultisigPage'},
      { path: '/EthereumAddressPage/:key?/:name?/:address?/:net?', component: () => import('pages/EthereumAddressPage.vue'), name: 'EthereumPage'},
