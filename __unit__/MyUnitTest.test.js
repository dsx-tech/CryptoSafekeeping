...
import { SignTransaction } from '@/pages/BitcoinPage.vue'
...
describe('BitcoinPage.vue', () => {
  it("displays a non authorized message", () => {
    it('sets the correct default data', () => {
        const defaultData = SignTransaction('7d067b4a697a09d2c3cff7d4d9506c9955e93bff41bf82d439da7d030382bc3e', '1KRMKfeZcmosxALVYESdPNez1AP1mEtywp', 0.8)
