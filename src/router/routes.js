...
const routes = [
  {
    ...
    children: [
      ...
      { path: '/EthereumMultisigAddressPage/:signs?/:holders?/:keylist?/:address?/:name?/:contacts?', component: () => import('pages/EthereumMultisigAddressPage.vue'), name: 'EthereumMultisigPage'},
